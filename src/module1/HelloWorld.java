...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider microsoftProvider = new Microsoft.AerialProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		// 320 width, 500 height, +50 to each to get
		map1 = new UnfoldingMap(this, 50, 50, 320, 500, provider);
		map2 = new UnfoldingMap(this, 400, 50, 320, 500, provider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    // added Scarborough
	    map2.zoomAndPanTo(zoomLevel, new Location(43.8f, -79.2f));
